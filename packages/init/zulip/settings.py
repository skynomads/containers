...
ZULIP_ADMINISTRATOR = getenv("ZULIP_ADMINISTRATOR", "zulip-admin@example.com")
...
EXTERNAL_HOST = getenv("EXTERNAL_HOST", "zulip.example.com")
...
EMAIL_HOST = getenv("EMAIL_HOST", "smtp.example.com")
...
NOREPLY_EMAIL_ADDRESS =  getenv("NOREPLY_EMAIL_ADDRESS", "noreply@example.com")
...
REMOTE_POSTGRES_HOST = getenv("REMOTE_POSTGRES_HOST", "dbserver.example.com")
REMOTE_POSTGRES_PORT = getenv("REMOTE_POSTGRES_PORT", "5432")
REMOTE_POSTGRES_SSLMODE = getenv("REMOTE_POSTGRES_SSLMODE", "require")
...
ENABLE_FILE_LINKS = getenv("ENABLE_FILE_LINKS", "false") == "true"
...
LOCAL_UPLOADS_DIR = getenv("LOCAL_UPLOADS_DIR", "/home/zulip/uploads")
S3_AUTH_UPLOADS_BUCKET = getenv("S3_AUTH_UPLOADS_BUCKET", "")
S3_AVATAR_BUCKET = getenv("S3_AVATAR_BUCKET", "")
S3_REGION = getenv("S3_REGION", None)
S3_ENDPOINT_URL = getenv("S3_ENDPOINT_URL", None)
S3_SKIP_PROXY = getenv("S3_SKIP_PROXY", "true") == "true"
...
MAX_FILE_UPLOAD_SIZE = int(getenv("NAME_CHANGES_DISABLED", "25"))
...
NAME_CHANGES_DISABLED = getenv("NAME_CHANGES_DISABLED", "false") == "true"
...
## integrated LDAP/Active Directory.
AVATAR_CHANGES_DISABLED = getenv("AVATAR_CHANGES_DISABLED", "false") == "true"

## Controls whether users who have not uploaded an avatar will receive an avatar
## from gravatar.com.
ENABLE_GRAVATAR = getenv("ENABLE_GRAVATAR", "true") == "true"
